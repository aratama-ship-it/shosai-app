# design-lint レポート — 127.0.0.1/docs/romeo-juliet-sample-2026-09-09/stage-sketch/full-show

- URL: http://127.0.0.1:18759/docs/romeo-juliet-sample-2026-09-09/stage-sketch/full-show/
- 測定時刻: 2026-09-11T01:27:20+09:00, 2026-09-11T01:27:21+09:00
...
- 備考: 既存の通し稿の紙面を引き継いだサンプル保存用HTML。実アプリの検証はcheck_sample.py。
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 5.94:1／実数測定 49件／WARN 0件 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
| C2 | 本文の純黒 | OK | 純黒 0件／本文 39件 | 本文に #000000 を使わない | §12-19 |
...
| T2 | 行長 | 情報 | 5.4〜24.0字/行（近似）／範囲外 27件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
| T3 | ジャンプ率 | 情報 | 1.53倍（26.0px / 本文 17.0px） | 最大見出し / 本文 ≒ 2倍 | §12-15 |
| T4 | 書体の種類数 | OK | 2種類: Hiragino Kaku Gothic ProN, Hiragino Mincho ProN | 1〜2種類 | §12-18 |
| U1 | タップ対象の大きさ | OK | 44px未満 0件／対象 9件 | 44×44px以上 | §12-21 |
...
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 0件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.80〜1.80／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 9.0〜43.0字/行（近似）／範囲外 15件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
