...
- URL: http://127.0.0.1:18743/direction-notes/
- 測定時刻: 2026-09-09T11:27:43+09:00, 2026-09-09T11:27:44+09:00
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 5.94:1／実数測定 90件／WARN 0件 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
| C2 | 本文の純黒 | OK | 純黒 0件／本文 77件 | 本文に #000000 を使わない | §12-19 |
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 1件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.75〜1.80／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 1.3〜22.5字/行（近似）／範囲外 55件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
...
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 1件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.75〜1.80／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 1.5〜46.5字/行（近似）／範囲外 42件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
