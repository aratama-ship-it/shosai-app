# design-lint レポート — 127.0.0.1/scene-outline

- URL: http://127.0.0.1:18743/scene-outline/
- 測定時刻: 2026-09-09T03:44:25+09:00, 2026-09-09T03:44:26+09:00
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 5.94:1／実数測定 111件／WARN 0件 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
| C2 | 本文の純黒 | OK | 純黒 0件／本文 71件 | 本文に #000000 を使わない | §12-19 |
...
| T2 | 行長 | 情報 | 7.0〜22.0字/行（近似）／範囲外 69件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
...
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 3件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.75〜1.80／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 7.0〜47.0字/行（近似）／範囲外 54件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
