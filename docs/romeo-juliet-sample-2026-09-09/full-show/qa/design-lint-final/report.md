...
- 測定時刻: 2026-09-11T01:03:30+09:00, 2026-09-11T01:03:33+09:00
...
- 備考: Explicit hidden details, phrase wrapping. Same tokens and 19-cue full performance proposal.
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 5.45:1／実数測定 896件／WARN 0件 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
| C2 | 本文の純黒 | OK | 純黒 0件／本文 766件 | 本文に #000000 を使わない | §12-19 |
...
| T2 | 行長 | 情報 | 1.7〜21.5字/行（近似）／範囲外 245件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
...
| U1 | タップ対象の大きさ | OK | 44px未満 0件／対象 58件 | 44×44px以上 | §12-21 |
...
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 3件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.80〜1.80／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 1.4〜43.0字/行（近似）／範囲外 236件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
