...
- URL: http://127.0.0.1:18746/#RJ-COND-01-A-01
- 測定時刻: 2026-09-11T00:20:20+09:00, 2026-09-11T00:20:21+09:00
...
- 備考: 2026-09-11: Benvolio stopping gesture and Tybalt challenge before blackout.
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 5.94:1／実数測定 71件／WARN 0件／無効UI部品 1件は対象外 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
