...
- URL: http://127.0.0.1:8941/docs/native-music-edit-2026-09-12/preview.html
- 測定時刻: 2026-09-12T20:22:47+09:00
- ビューポート: 1440×900
...
- 備考: Final music layout: 44px targets, native renderer, no production writes
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 4.89:1／実数測定 79件／WARN 0件 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
| C2 | 本文の純黒 | OK | 純黒 0件／本文 24件 | 本文に #000000 を使わない | §12-19 |
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 0件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.60〜1.80／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 1.0〜75.5字/行（近似）／範囲外 21件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
| T3 | ジャンプ率 | 情報 | 1.87倍（28.0px / 本文 15.0px） | 最大見出し / 本文 ≒ 2倍 | §12-15 |
...
| U2 | ナビゲーション項目数 | 情報 | nav:nth-of-type(1): 3項目 | 4〜5以内 | §12-24 |
| U3 | アイコンのみボタンの aria-label | OK | 欠落 0件／アイコンのみ 4件 | aria-label 必須 | design-policy「多言語前提のUI表現はアイコン基本」 |
| U4 | ボタンの被覆 | OK | 被覆 0件／ボタン 26件 | 中心点で自分または子要素を取得できる | UI_AUDIT実績 |
