# design-lint レポート — 127.0.0.1/docs/stage-pages-p0-release-2026-09-14

- URL: http://127.0.0.1:8947/docs/stage-pages-p0-release-2026-09-14/
- 測定時刻: 2026-09-14T13:00:15+09:00, 2026-09-14T13:00:16+09:00
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 5.59:1／実数測定 41件／WARN 0件 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
| C2 | 本文の純黒 | OK | 純黒 0件／本文 31件 | 本文に #000000 を使わない | §12-19 |
...
| T2 | 行長 | 情報 | 8.8〜20.0字/行（近似）／範囲外 15件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
| T3 | ジャンプ率 | 情報 | 1.88倍（30.0px / 本文 16.0px） | 最大見出し / 本文 ≒ 2倍 | §12-15 |
| T4 | 書体の種類数 | OK | 1種類: -apple-system | 1〜2種類 | §12-18 |
...
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 12件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.80〜1.80／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 8.8〜59.0字/行（近似）／範囲外 7件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
| T3 | ジャンプ率 | 情報 | 2.75倍（44.0px / 本文 16.0px） | 最大見出し / 本文 ≒ 2倍 | §12-15 |
| T4 | 書体の種類数 | OK | 1種類: -apple-system | 1〜2種類 | §12-18 |
| U1 | タップ対象の大きさ | OK | 44px未満 0件／対象 14件 | 44×44px以上 | §12-21 |
| U2 | ナビゲーション項目数 | 情報 | ナビゲーションなし | 4〜5以内 | §12-24 |
| U3 | アイコンのみボタンの aria-label | OK | 欠落 0件／アイコンのみ 0件 | aria-label 必須 | design-policy「多言語前提のUI表現はアイコン基本」 |
