# design-lint レポート — 127.0.0.1/docs/viewer-integration-20260912

- URL: http://127.0.0.1:8815/docs/viewer-integration-20260912/
- 測定時刻: 2026-09-12T00:15:58+09:00, 2026-09-12T00:15:59+09:00
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 9.19:1／実数測定 33件／WARN 0件／無効UI部品 1件は対象外 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
| C2 | 本文の純黒 | OK | 純黒 0件／本文 23件 | 本文に #000000 を使わない | §12-19 |
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 3件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.70〜1.70／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 0.5〜21.8字/行（近似）／範囲外 17件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
| T3 | ジャンプ率 | 情報 | 1.75倍（28.0px / 本文 16.0px） | 最大見出し / 本文 ≒ 2倍 | §12-15 |
| T4 | 書体の種類数 | OK | 1種類: system-ui | 1〜2種類 | §12-18 |
| U1 | タップ対象の大きさ | OK | 44px未満 0件／対象 7件 | 44×44px以上 | §12-21 |
...
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 3件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.70〜1.70／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 0.6〜45.0字/行（近似）／範囲外 13件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
| T3 | ジャンプ率 | 情報 | 1.75倍（28.0px / 本文 16.0px） | 最大見出し / 本文 ≒ 2倍 | §12-15 |
| T4 | 書体の種類数 | OK | 1種類: system-ui | 1〜2種類 | §12-18 |
| U1 | タップ対象の大きさ | OK | 44px未満 0件／対象 7件 | 44×44px以上 | §12-21 |
| U2 | ナビゲーション項目数 | 情報 | ナビゲーションなし | 4〜5以内 | §12-24 |
