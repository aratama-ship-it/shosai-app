...
const state={attentionOnly:false,version:'original',page:0,annotations:[],selected:null,pending:null,mode:'with',left:true,right:true,side:'right',zoom:false,scene:3};
...
function render(){if(!fixture)return;layout();renderPage();renderMarks();renderHealth();syncSelection();$('undo').disabled=!history.length;$('version').value=state.version;
