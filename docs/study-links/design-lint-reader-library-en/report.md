# design-lint レポート — Stage Sketch reader library en

- URL: http://127.0.0.1:8800/study?lang=en
- 測定時刻: 2026-09-09T20:07:15+09:00, 2026-09-09T20:07:16+09:00
...
| T2 | 行長 | 情報 | 5.5〜14.8字/行（近似）／範囲外 17件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
...
| C3 | 色だけに頼ったリンク表現 | OK | 手がかりなし 0件／本文中リンク 5件 | 本文中リンクに色以外の手がかり | §12-17 |
| T1 | 行送り | OK | 1.60〜1.60／normal等の数値化不可 0件 | line-height / font-size = 1.5〜2.0 | §12-15 |
| T2 | 行長 | 情報 | 5.5〜44.5字/行（近似）／範囲外 16件 | 1行 30〜50字（全角換算・近似値） | §12-15 |
| T3 | ジャンプ率 | 情報 | 1.50倍（24.0px / 本文 16.0px） | 最大見出し / 本文 ≒ 2倍 | §12-15 |
| T4 | 書体の種類数 | OK | 1種類: system-ui | 1〜2種類 | §12-18 |
| U1 | タップ対象の大きさ | OK | 44px未満 0件／対象 8件 | 44×44px以上 | §12-21 |
| U2 | ナビゲーション項目数 | 情報 | #study-account: 2項目 | 4〜5以内 | §12-24 |
