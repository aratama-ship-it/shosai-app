...
- 測定時刻: 2026-09-09T18:17:12+09:00, 2026-09-09T18:17:13+09:00
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 7.67:1／実数測定 20件／WARN 0件／無効UI部品 2件は対象外 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
