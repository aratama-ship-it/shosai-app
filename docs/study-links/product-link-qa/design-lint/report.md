...
- 測定時刻: 2026-09-10T15:05:17+09:00, 2026-09-10T15:05:19+09:00
...
| ID | 項目 | 判定 | 実測 | 基準 | 出典 |
|---|---|---|---|---|---|
| C1 | 文字と背景のコントラスト比 | OK | 最悪 4.91:1／実数測定 28件／WARN 0件 | 本文 4.5:1以上／大きい文字・UI部品 3:1以上 | §12-16 |
...
| U1 | タップ対象の大きさ | OK | 44px未満 0件／対象 15件 | 44×44px以上 | §12-21 |
...
| M1 | prefers-reduced-motion 対応 | OK | 通常 9要素/最大120ms → reduce 0要素/最大0ms; 要素別対応 9/9 | 動きがある場合は分岐必須 | A_design §5 |
