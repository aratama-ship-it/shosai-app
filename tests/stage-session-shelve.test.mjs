...
test("変更したJS版とPWAキャッシュ版を正本・単独版・Service Workerで揃える", () => {
  for (const reference of ["stage-sketch.js?v=478", "stage-timeline.js?v=56", "stage-session.js?v=19"]) {
  ...
  assert.match(serviceWorkerSource, /const CACHE_NAME = "stage-sketch-pwa-v482";/);
});
