...
(function () {
  ...
  const MAPS = {
    ...
    venueNote: {
      ...
      chapiteau: "A small touring tent of the contemporary kind. The ring at the centre is 7 m across and four blocks of seating surround it, up to 240 places. The masts stand outside, so nothing obstructs the space inside. The crown sits at 5.5 m, which leaves little room overhead for aerial work. The traditional 13 m ring — the international standard since Philip Astley in 1768 — belongs to the 〈Big top〉 preset. Pitching it needs 35 × 35 m of flat ground.",
    ...
    size: {
      ...
      touring: "Touring tent (7 m ring, 240 seats)",
