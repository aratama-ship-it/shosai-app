...
export const STUDY_PUBLIC_ASSETS = new Set([
  ...
  '/study-assets/stage-i18n.js', '/study-assets/stage-set-model.js', '/study-assets/stage-machinery.js', '/study-assets/style.css',
]);
...
// Beta-only bearer-link access. Account-required deployments fail closed by default.
export const studyAllowsAnonymous = env => env.STAGE_BETA_ACTIVE === 'true' && env.STUDY_ALLOW_ANONYMOUS === 'true';
