...
(function () {
  ...
  const SEATS = [
    ...
    },
    {
      ...
      // ここまで近いと舞台の端は視界に入らない。広角で覗いたように、手前を大きく
      // 広げて画面の外まで流す。床は目線の高さなので、ほとんど線になる。
      id: "front", label: "1階 最前列", short: "最前",
      note: "目線が床と同じ高さ。演者を見上げ、舞台の端は視界からこぼれる。",
      backY: 12, floorY: 652, bottomY: 714, backW: 0.99, frontW: 1.52, shift: 0, rise: 0.46,
    },
    {
