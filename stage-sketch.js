...
(function () {
  ...
  const POSES = [
    ...
    makePose("tuck", "抱え込み宙返り", {
      ...
      neck: [0, 0.945, 0.185],
      head: [0, 1.025, 0.185],
      // 腿は腰から塊の天井へ、脛はそこから顎の下へ降りる（膝はおよそ100度）
      knL: [-0.085, 1.052, 0.03], knR: [0.085, 1.052, 0.03],
      anL: [-0.08, 0.861, 0.191], anR: [0.08, 0.861, 0.191],
      toL: [-0.078, 0.815, 0.235], toR: [0.078, 0.815, 0.235],
      // 腕は脛を抱える
      elL: [-0.195, 0.90, 0.16], elR: [0.195, 0.90, 0.16],
      wrL: [-0.092, 0.885, 0.175], wrR: [0.092, 0.885, 0.175],
  ...
  function pieceLabel(piece) {
    ...
    return piece ? PIECE_TYPES[piece.type] : "これ";
  }
