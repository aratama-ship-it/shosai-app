...
(function () {
  ...
  const POLE_FLAG_R = {
    ...
    joints: {
      head: [0.17, 0.10, 0], neck: [0.22, 0.05, 0],
      shL: [0.26, 0.045, -0.05], shR: [0.26, -0.005, 0.05],
      elL: [0.14, 0.16, 0], wrL: [0.0, 0.26, 0],
      elR: [0.15, -0.14, 0], wrR: [0.0, -0.26, 0],
      hipL: [0.55, -0.015, -0.045], hipR: [0.55, -0.055, 0.045],
      knL: [0.74, 0.115, 0.01], anL: [0.895, 0.25, 0], toL: [0.935, 0.29, 0.02],
      knR: [0.72, -0.21, 0.01], anR: [0.83, -0.375, 0], toR: [0.85, -0.44, 0.02],
    },
  };
  ...
  function pieceParts(piece) {
    ...
    if (piece.type === "pole") {
      ...
      // 太さは0.04mまでに抑える（前の既定0.06で保存された駒にも効かせる）
      const pw = Math.min(d.w, 0.04);
      return [
